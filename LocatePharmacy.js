    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.inside_container}>
                <TouchableOpacity onPress={() => handlePress("Prescription")} style={styles.prescription_button}>
                    <Text style={styles.prescription_button_text}>Digital Prescription</Text>
                </TouchableOpacity>
